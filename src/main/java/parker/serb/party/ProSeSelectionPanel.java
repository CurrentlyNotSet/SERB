 ...
 * @author parker
 */
public class ProSeSelectionPanel extends javax.swing.JDialog {
    ...
    private void setLabel(String partyType) {
        jLabel1.setText("Will the " + partyType + " be represented Pro Se?");
    }
