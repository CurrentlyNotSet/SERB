 ...
 */
public class CSCCaseSearch extends javax.swing.JDialog {
     ...
     */
    public CSCCaseSearch(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        addRenderer();
        ...
        caseSearchTable.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                if(e.getClickCount() == 2) {
                    setVisible(false);
                    Global.root.getcSCHeaderPanel1().getjComboBox2().setSelectedItem(caseSearchTable.getValueAt(caseSearchTable.getSelectedRow(), 1).toString());
                }
            }
