 ...
 * @author User
 */
public class RetentionExclusionSearchDialog extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public RetentionExclusionSearchDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        addRenderer();
        setColumnSize();
    ...
    private void loadTable() {
        ...
        List<RetentionExclusion> databaseList = RetentionExclusion.searchRetentionExclusion(param);

        for (RetentionExclusion item : databaseList) {
    ...
    private void update(){
        if (SearchTable.getSelectedRow() > -1) {
            ...
            ActiveStatus.updateActiveStatus("RetentionExclusion", active, id);
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Record Retention Exclusion Maintenance");
        ...
        SearchTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Active", "Section", "Excluded Text"
            }
        ) {
    ...
    private void AddNewButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddNewButtonActionPerformed
        new RetentionExclusionAddEditDialog(null, true, 0);
        loadTable();
    }//GEN-LAST:event_AddNewButtonActionPerformed

    private void EditButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditButtonActionPerformed
        if ((int) SearchTable.getValueAt(SearchTable.getSelectedRow(), 0) > 0){
            new RetentionExclusionAddEditDialog(null, true, (int) SearchTable.getValueAt(SearchTable.getSelectedRow(), 0));
            loadTable();
        }
