 ...
 * @author User
 */
public class AppealCourtSearchDialog extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public AppealCourtSearchDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        addRenderer();
        setColumnSize();
    ...
    private void loadTable() {
        ...
        List<AppealCourt> databaseList = AppealCourt.loadAllAppealCourt(param);

        for (AppealCourt item : databaseList) {
    ...
    private void update(){
        if (SearchTable.getSelectedRow() > -1) {
            ...
            ActiveStatus.updateActiveStatus("AppealCourt", active, id);
        }
    }
    ...
    private void AddNewButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddNewButtonActionPerformed
        new AppealCourtAddEditDialog(null, true, 0);
        loadTable();
    }//GEN-LAST:event_AddNewButtonActionPerformed

    private void EditButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditButtonActionPerformed
        if ((int) SearchTable.getValueAt(SearchTable.getSelectedRow(), 0) > 0){
            new AppealCourtAddEditDialog(null, true, (int) SearchTable.getValueAt(SearchTable.getSelectedRow(), 0));
            loadTable();
        }
