 ...
 * @author User
 */
public class DirectorSearchDialog extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public DirectorSearchDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        addRenderer();
        setColumnSize();
    ...
    private void loadTable() {
        ...
        List<Director> databaseList = Director.loadAllDirectors(param);

        for (Director item : databaseList) {
    ...
    private void update(){
        if (SearchTable.getSelectedRow() > -1) {
            ...
            ActiveStatus.updateActiveStatus("Director", active, id);
        }
    }
    ...
    private void AddNewButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddNewButtonActionPerformed
        new DirectorAddEditDialog(null, true, 0);
        loadTable();
    }//GEN-LAST:event_AddNewButtonActionPerformed

    private void EditButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditButtonActionPerformed
        if ((int) SearchTable.getValueAt(SearchTable.getSelectedRow(), 0) > 0){
            new DirectorAddEditDialog(null, true, (int) SearchTable.getValueAt(SearchTable.getSelectedRow(), 0));
            loadTable();
        }
