 ...
 * @author User
 */
public class CMDSTemplateSearchDialog extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public CMDSTemplateSearchDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        addRenderer();
        setDefaults();
    ...
    private void loadTable() {
        ...
        model.setRowCount(0);
        List<CMDSDocuments> databaseList = null;
        
        String[] param = searchTextBox.getText().trim().split(" ");
            databaseList = CMDSDocuments.loadAllCMDSDocuments(param);

        for (CMDSDocuments item : databaseList) {
    ...
    private void update(){
        if (SearchTable.getSelectedRow() > -1) {
            ...
            boolean active = (boolean) SearchTable.getValueAt(SearchTable.getSelectedRow(), 1);
                ...
                ActiveStatus.updateActiveStatus("CMDSDocuments", active, id);
    ...
    private void initComponents() {
        ...
        headerLabel.setText("CMDS Templates");
        ...
        SearchTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Active", "Main Cat.", "Sub Cat.", "Letter Name"
            }
        ) {
    ...
    private void AddNewButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddNewButtonActionPerformed
        new CMDSTemplateAddEditDialog(null, true, 0);
        loadTable();
    }//GEN-LAST:event_AddNewButtonActionPerformed

    private void EditButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditButtonActionPerformed
        if ((int) SearchTable.getValueAt(SearchTable.getSelectedRow(), 0) > 0){
            new CMDSTemplateAddEditDialog(null, true, (int) SearchTable.getValueAt(SearchTable.getSelectedRow(), 0));
            loadTable();
        }
