...
public class CMDSHistoryDescriptionSearchDialog extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public CMDSHistoryDescriptionSearchDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setColumnSize();
        loadingThread();
    ...
    private void loadTable() {
        ...
        List<CMDSHistoryDescription> databaseList = CMDSHistoryDescription.loadAllStatusTypes(param);
    ...
    private void AddNewButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddNewButtonActionPerformed
        new CMDSHistoryDescriptionAddEditDialog(null, true, 0);
        loadTable();
    }//GEN-LAST:event_AddNewButtonActionPerformed

    private void EditButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditButtonActionPerformed
        if ((int) SearchTable.getValueAt(SearchTable.getSelectedRow(), 0) > 0){
            new CMDSHistoryDescriptionAddEditDialog(null, true, (int) SearchTable.getValueAt(SearchTable.getSelectedRow(), 0));
            loadTable();
        }
