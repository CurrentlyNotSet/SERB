...
public class MEDStrikePanel extends javax.swing.JPanel {
    ...
    public void saveInformation() {
        ...
        newCaseInformation.FFEmployerType = EmployerTypeComboBox.getSelectedItem().toString().trim().equals("") ? null : EmployerTypeComboBox.getSelectedItem().toString();
        newCaseInformation.FFEmployeeType = EmployeeTypeComboBox.getSelectedItem().toString().trim().equals("") ? null : EmployeeTypeComboBox.getSelectedItem().toString();
    ...
    private void initComponents() {
        ...
        strikeFileDateTextBox.setCalendarCustomizer(new Customizer<WebCalendar> ()
            ...
            intendedDateStrikeTextBox.setCalendarCustomizer(new Customizer<WebCalendar> ()
                ...
                jLabel20.setText("Employer Type:");
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            .addComponent(EmployerTypeComboBox, 0, 119, Short.MAX_VALUE)
