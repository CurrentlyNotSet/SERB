...
public class CMDSAddHistoryEntryDialog extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CMDSAddHistoryEntryDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CMDSAddHistoryEntryDialog dialog = new CMDSAddHistoryEntryDialog(new javax.swing.JFrame(), true);
