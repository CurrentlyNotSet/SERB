 ...
 */
public class AddMultiCaseElection extends javax.swing.JDialog {

    /**
     * Creates new form AddNewRelatedCase
     */
    public AddMultiCaseElection(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        if(caseNumberTextBox.getText().trim().length() == 16) {
            ...
            else if(!REPElectionMultiCase.checkCaseIsAlreadyPresent(caseNumberTextBox.getText().trim().toUpperCase())) {
                caseNotFoundLabel.setText("Case is already present");
            }
            else if(CaseValidation.validateCaseNumber(caseNumberTextBox.getText().trim().toUpperCase())) {
                REPElectionMultiCase.addMultiCase(caseNumberTextBox.getText().trim().toUpperCase());
                dispose();
            }
            else {
                caseNotFoundLabel.setText("Case Number Not Found");
