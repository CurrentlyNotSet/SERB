 ...
 */
public class HearingCaseSearch extends javax.swing.JDialog {
        ...
        caseSearchTable.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                if(e.getClickCount() == 2) {
                    setVisible(false);
                    Global.root.getHearingHeaderPanel1().getjComboBox2().setSelectedItem(caseSearchTable.getValueAt(caseSearchTable.getSelectedRow(), 0).toString());
                }
            }
    ...
    private void loadAllCases() {
        ...
        for (Object caseItem : caseList) {
            HearingCaseSearchData act = (HearingCaseSearchData) caseItem;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Hearing Case Search");
        ...
        caseSearchTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Case Number", "Status", "Parties", "Board Action PC Date", "ALJ", "Board Action Date"
            }
        ) {
