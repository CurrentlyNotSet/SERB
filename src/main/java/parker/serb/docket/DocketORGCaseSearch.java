 ...
 */
public class DocketORGCaseSearch extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public DocketORGCaseSearch(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        addRenderer();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ORG Case Search");
