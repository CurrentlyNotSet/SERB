 ...
 */
public class mediaFileDialog_NEW extends javax.swing.JDialog {
     ...
     * @param section
     */
    public mediaFileDialog_NEW(java.awt.Frame parent, boolean modal, String file, String section, String time) {
        super(parent, modal);
        initComponents();
