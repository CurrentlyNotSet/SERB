...
//    }
    ...
    private void generateReport() {
        ...
        GenerateReport.generateMailLogFROMReport(where,
                Global.mmddyyyy.format(startDateField.getDate()),
                Global.mmddyyyy.format(endDateField.getDate()),
                assignedToCombobox.getSelectedItem().toString().trim().equals("All") ? "" : assignedToCombobox.getSelectedItem().toString().trim(),
                Global.activeSection,
                doc
        );
        ...
        if (jTable1.getSelectedRow() > -1) {
            ...
            if (evt.getClickCount() == 2 && !fileName.equals("")) {
                switch (Global.activeSection) {
                    case "ORG":
                        FileService.openFileWithORGNumber("ORG", jTable1.getValueAt(jTable1.getSelectedRow(), 3).toString(), fileName);
                        break;
                    case "CSC":
                    case "Civil Service Commission":
                        FileService.openFileWithORGNumber("CSC", jTable1.getValueAt(jTable1.getSelectedRow(), 3).toString(), fileName);
                        break;
                    default:
