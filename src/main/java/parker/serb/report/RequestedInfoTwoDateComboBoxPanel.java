 ...
 * @author User
 */
public class RequestedInfoTwoDateComboBoxPanel extends javax.swing.JDialog {
     ...
     * @param IDType
     */
    public RequestedInfoTwoDateComboBoxPanel(java.awt.Frame parent, boolean modal, SMDSDocuments reportPassed, String IDType) {
        super(parent, modal);
        report = reportPassed;
        initComponents();
    ...
    private void loadCombobox(String IDType) {
        ...
        switch (IDType) {
            case "EmployerType":
                List<String> list = Arrays.asList("City", "County", "School District", "Township", "University", "State Govt.", "Other");
    ...
    private void generateButton() {
        if (startDateField.toString().trim().equals("")
                ...
                || ComboBox.getSelectedItem().toString().trim().equals("")) {
    ...
    private void GenerateReportButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GenerateReportButtonActionPerformed
        String SelectedItem = ComboBox.getSelectedItem().toString().trim().equals("All") ? "%" : ComboBox.getSelectedItem().toString().trim();
        GenerateReport.generateTwoDatesExactStringReport(startDateField.getText(), endDateField.getText(), SelectedItem, report);
